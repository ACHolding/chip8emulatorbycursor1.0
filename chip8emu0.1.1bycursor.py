#!/usr/bin/env python3
"""chip8emulator by cursor 0.1

CHIP-8 emulator with an mGBA-style GUI: menu bar, toolbar, framed display,
status bar — dark chrome with blue accents; toolbar buttons use black fill
and blue labels.
